...
<div class="row">
      <div class="panel well">
        <div class="row">
            <div class="col-md-12">
                <h2><center><strong><font color="blue">Halo <?php echo $_SESSION['user']['nama_user'];?><i class="fa fa-user"></i></font></strong></center></h2><span></span>
                    <div class="col-xs-12">
                    <font color="grey"><h4>Selamat datang di Aplikasi Kependudukan Warungboto - Yogyakarta</h4></font>
                </div>
                </div>
                <!-- /.col-lg-12 -->
            <!-- /.row -->
